      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li><a href="localstorage-memory.js.html">localstorage-memory.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
            </ul>
        ...
        <div class="span9">
          <section id="Main"><h1>localstorage-memory</h1>
<blockquote>
<p>localStorage-compatible API, but only stored in memory</p></blockquote>
<p><a href="https://travis-ci.org/gr2m/localstorage-memory/"><img src="https://travis-ci.org/gr2m/localstorage-memory.png?branch=master" alt="Build Status"></a></p><p><code>localStorageMemory</code> provides all methods that <code>localStorage</code> in browsers<br />provides, but no data is persisted, it&#39;s only stored in memory. It can<br />be used as a drop-in replacement, the only exception being the<br />Associative array syntax <code>localStorage[&#39;myKey&#39;] = &#39;myValue&#39;</code>.</p><h2>Download or Installation</h2>
<ul>
<li>Download <a href="https://raw.githubusercontent.com/gr2m/localstorage-memory/master/lib/localstorage-memory.js">localstorage-memory.js</a></li>
<li>or: install via Bower: <code>bower install --save localstorage-memory</code></li>
<li>or: install via npm: <code>npm install --save localstorage-memory</code></li>
</ul>
<h2>Usage</h2>
<pre><code class="lang-js">localStorageMemory.getItem(&#39;unknown&#39;) // null
...
<h1>Related</h1>
<ul>
<li><a href="https://github.com/lmaccherone/node-localstorage">https://github.com/lmaccherone/node-localstorage</a><br />provides a <code>localStorage</code> API, with data being persisted at provide path</li>
</ul>
<h2>License</h2>
<p>MIT</p></section>
        </div>
