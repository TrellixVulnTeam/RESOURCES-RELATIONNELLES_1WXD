...
<html>
      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="api.js.html">api.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#create"><i class="alert alert-info"></i><span>create</span></a>
              </li>
              <li><a href="#setObject"><i class="alert alert-info"></i><span>setObject</span></a>
              </li>
              <li><a href="#getObject"><i class="alert alert-info"></i><span>getObject</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="create">
            ...
            <p>
              <div class="label label-info radius ctx-type">method</div><span>hoodie.store.create()</span>
            </p>
          </section>
          <div class="description"><p>returns localStorage-compatible API, either backed by window.localStorage<br />or memory if it&#39;s not available or not persistent.</p><p>It also adds an object API (<code>.getObject(key)</code>,<br /><code>.setObject(key, properties)</code>) and a <code>isPresistent</code> property</p> </div>
          <pre><code class="language-javascript">exports.create = function () {
  var api;
  ...
  return api;
          ...
          <section id="setObject">
            <h1>setObject</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>hoodie.store.setObject()</span>
            </p>
          </section>
          <div class="description"><p>sets key to passed Object.</p> </div>
          <pre><code class="language-javascript">exports.setObject = function (store, key, object) {
  ...
  return store.setItem(key, JSON.stringify(object));
          ...
          <section id="getObject">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>hoodie.store.getObject()</span>
            </p>
          </section>
          <div class="description"><p>returns Object for key, or null</p> </div>
          <pre><code class="language-javascript">exports.getObject = function (store, key) {
