...
<html>
  <head>
    ...
    <title>humble-localstorage</title>
      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li><a href="api.js.html">api.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
            </ul>
        ...
        <div class="span9">
          <section id="Main"><h1>humble-localstorage</h1>
<blockquote>
<p>wraps localStorage and adds .getObject(), .setObject(), .isPersistent</p></blockquote>
<p><a href="https://travis-ci.org/gr2m/humble-localstorage/"><img src="https://travis-ci.org/gr2m/humble-localstorage.png?branch=master" alt="Build Status"></a></p><p><code>localStorage</code> is a simple key/value store API for browsers, perfectly<br />suited to store little amount of data like configurations.</p><p><code>humbleLocalStorage</code> provides additional APIs to store / retrieve<br />JSON objects, and also handles several circumstances in which Browsers<br />do not support or persist localStorage (e.g. private modes,<br />Cookies disabled, etc).</p><p>In case data cannot be persisted in localStorage,  <code>humbleLocalStorage</code><br />falls back to in-memory storage. To determine if data is being persisted,<br />use <code>humbleLocalStorage.isPersistent</code> property.</p><h2>Installation</h2>
<ul>
<li>Download: <a href="https://github.com/gr2m/humble-localstorage/releases">https://github.com/gr2m/humble-localstorage/releases</a></li>
<li>or: install via Bower: <code>bower install -S humble-localstorage</code></li>
<li>or: install via npm: <code>npm install -S humble-localstorage</code></li>
</ul>
<h2>Usage</h2>
<pre><code class="lang-js">humbleLocalStorage.getItem(&#39;mykey&#39;) // string value or null
