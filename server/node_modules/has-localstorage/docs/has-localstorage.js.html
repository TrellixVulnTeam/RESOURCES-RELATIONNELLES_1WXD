      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="has-localstorage.js.html">has-localstorage.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#hasLocalStorage"><i class="alert alert-info"></i><span>hasLocalStorage</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="hasLocalStorage">
            <h1>hasLocalStorage</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.hasLocalStorage()</span>
            </p>
          </section>
          <div class="description"><h1>hasLocalStorage()</h1>
<p>returns <code>true</code> or <code>false</code> depending on whether localStorage is supported or not.<br />Beware that some browsers like Safari do not support localStorage in private mode.</p><p>inspired by this cappuccino commit<br /><a href="https://github.com/cappuccino/cappuccino/commit/063b05d9643c35b303568a28809e4eb3224f71ec">https://github.com/cappuccino/cappuccino/commit/063b05d9643c35b303568a28809e4eb3224f71ec</a></p> </div>
          <pre><code class="language-javascript">function hasLocalStorage() {
  try {
