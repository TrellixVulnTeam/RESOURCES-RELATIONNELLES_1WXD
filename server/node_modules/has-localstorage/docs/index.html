      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li><a href="has-localstorage.js.html">has-localstorage.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
            </ul>
        ...
        <div class="span9">
          <section id="Main"><h1>has-localstorage</h1>
<blockquote>
<p>returns true if localStorage is supported <em>and</em> persistent</p></blockquote>
<p><a href="https://travis-ci.org/gr2m/has-localstorage/"><img src="https://travis-ci.org/gr2m/has-localstorage.png?branch=master" alt="Build Status"></a></p><p>returns <code>true</code> or <code>false</code> depending on whether localStorage is supported or not.<br />Beware that some browsers like Safari do not support localStorage in private mode.</p><h2>Downlaod or Installation</h2>
<ul>
<li>Download <a href="https://raw.githubusercontent.com/gr2m/initials.js/master/lib/has-localstorage.js">has-localstorage.js</a></li>
<li>or: install via Bower: <code>bower install --save has-localstorage</code></li>
<li>or: install via npm: <code>npm install --save has-localstorage</code></li>
</ul>
<h2>Usage</h2>
<pre><code class="lang-js">if (hasLocalStorage()) {
...
<p><code>hasLocalStorage()</code> has been inspired by this <a href="http://www.cappuccino-project.org/">Cappuccino</a> commit:<br /><a href="https://github.com/cappuccino/cappuccino/commit/063b05d9643c35b303568a28809e4eb3224f71ec">https://github.com/cappuccino/cappuccino/commit/063b05d9643c35b303568a28809e4eb3224f71ec</a></p><h2>License</h2>
<p>MIT</p></section>
        </div>
      </div>
    </div>
